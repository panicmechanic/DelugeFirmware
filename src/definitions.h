...
#define audioEngineBufferSize 128 // Maximum num samples that may be processed in one "frame". Actual size of output buffer is in ssi.h
...
#define PERC_BUFFER_REDUCTION_MAGNITUDE 7 // This is about right. Making it smaller didn't help. Tried it as 9, and I'm pretty sure some fast percussive details were lost in the output
...
#define INPUT_ENABLE_REPITCHED_BUFFER 0 // Experimental, from when developing input pitch shifting. Probably won't actually work now, if it ever did!
...
#define PITCH_DETECT_WINDOW_SIZE_MAGNITUDE 13 // We don't want the window too short, or some sounds / harmonics can be missed during the attack
...
#define STEALABLE_QUEUE_CURRENT_SONG_SAMPLE_DATA_PERC_CACHE			9 // This one is super valuable and compacted data - lots of work to load it all again
...
#define WAVETABLE_MIN_CYCLE_SIZE 8 // Not 4 - because NE10 can't do FFTs that small unless we enable its additional C code, which would take up program size for little gain.
